...
Inductive step: state -> trace -> state -> Prop :=
  ...
  | exec_function_internal: forall s f rs m m' m'' sp rs' sz,
      ...
      Mem.record_stack_blocks m' (make_singleton_frame_adt sp (fn_stacksize f) sz) m'' ->
...
Inductive initial_state (p: program): state -> Prop :=
  | initial_state_intro: forall b f m0 m1 b1 m2,
      ...
      initial_state p (Callstate nil f (Locmap.init Vundef) m2 (fn_stack_requirements (prog_main p))).
